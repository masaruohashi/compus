  ...
  <div class="row">
    <div class="col-sm-4 col-sm-offset-4 login-box">
      ...
      <form class="form-group" action="login" method="POST">
        <label for="employee_cpf">CPF do Administrador:</label>
        <input class="cpf form-control" type="text" id="admin_cpf" name="admin_cpf" />
        <br>
        <label for="client_cpf">Senha:</label>
